<template>
    <view class="content">
		...
		<view class="position-fixed bg-white align-center"
			style="bottom: 0;width: 750rpx;height: 100rpx;z-index: 9999999999999;">
    ...
    export default {
		...
		methods: {
			...
			skipConceptualdesign(){
				uni.navigateTo({
					url:'/pages/tabbar/message/NavMenu/conceptualdesign?order_id='+this.order_id+'&module='+this.node_code
				})
			},
			// 联系设计师
			gotoIM(){

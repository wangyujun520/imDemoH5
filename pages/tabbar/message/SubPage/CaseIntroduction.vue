<template>
	<view class="content">
		<view class="bg-white flex p-2">
			<textarea v-model="title" placeholder="请输入案例介绍" class="w-100" style="font-size: 28rpx;"/>
		</view>
	...
	export default{
		...
		methods:{
			Submit(){
				...
				prevPage.$vm.DataList.introduce = this.title;//修改上一页data里面的managingGoods参数值
				// 返回上一个界面
				uni.navigateBack({
					delta:1
				})

<template>
	<view class="content p-2">
		<!-- <view v-if="DataList.cover == ''" @click="ChangeTheCover" class="flex flex-column align-center bg-white py-2" style="border-bottom: 1px solid rgba(187,187,187,0.2);">
			<view class="" style="width: 600rpx;height: 400rpx;background-color: #F7F7F7;"></view>
		...
		<view v-else @click="ChangeTheCover" class="flex flex-column align-center bg-white py-2" style="border-bottom: 1px solid rgba(187,187,187,0.2);">
			<image :src="DataList.cover" style="width: 600rpx;height: 400rpx;"></image>
		...
		<view @click="skipTitle" class="flex p-2 justify-between bg-white" style="border-bottom: 1px solid rgba(187,187,187,0.2);">
			<view class="flex flex-column">
				...
				<view class="flex" style="width: 600rpx;">
					<text style="color: #979797;font-size: 26rpx;" class="LineBreak1">{{DataList.title}}</text>
				</view>
			</view>
			<view class="flex">
	...
	export default {
		...
		onNavigationBarButtonTap: function(e) {
			if (this.isShow) {
				...
				var RequrestUrl =
					this.AJB.BizUrl + "api/Design/AddDesignConstruction";
		...
		onLoad(option) {
			...
			var RequrestUrl = this.AJB.BizUrl + "api/Design/GetDesignConstruction";
			var RequrestDatas = {
				id: option.id
			};
			this.AJB.UniAjax(RequrestUrl, RequrestDatas)
			...
			//this.DataList.TaskId = option.id;
		},
		methods: {
			// 加载图片
			loadImage(e) {

<template>
	<view class="u-wrap">
		<view class="u-search-box" @tap="skipProductSearch">
					...
					<view class="page-view">
						<view class="class-item">
							...
							<view class="item-container">
								<view class="thumb-box" @click="skipPage(item1)" v-for="(item1, index1) in item.list" :key="index1">
									<image class="item-menu-image" :src="item1.cover" mode=""></image>
									<view class="item-menu-name">{{item1.title}}</view>
								</view>
								<view v-if="item.list.length == 0" class="flex justify-center align-center" style="height: 85vh;width: 100%;">
	...
	export default {
		...
		methods: {
			...
			getTypes() {
				...
				// var RequrestUrl = this.AJB.BizUrl + "api/Communication/GetAllCategories";
				// var RequrestDatas = {};

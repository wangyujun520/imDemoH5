<template>
  <view class="content">
    <view
      class="flex flex-column mt-2 bg-white"
        ...
        <view class="" style="border-bottom: 1px solid rgb(187, 187, 187, 0.2)">
          <view class="flex px-2 pt-2">
            ...
            <view class="flex flex-column pl-1" style="width: 550rpx">
              <text
                class="LineBreak"
                style="color: #101010; font-size: 24rpx"
                >{{ item.commName }}</text
              >
              ...
              <view class="flex justify-between">
                <view class="flex">
                  <text style="color: #101010; font-size: 26rpx"
                    >参考价：{{ item.price }}</text
                  >
                </view>
                <view class="">
                  <u-number-box
                    v-model="item.count"
                    @change="valChange(item.count, item.commId)"
                  ></u-number-box>
                </view>
              </view>
            </view>
          ...
          <view class="flex justify-between p-2">
            ...
            <view class="">
              <text
                @click="ActionSheetShow(item.commId)"
                class="iconfont"
                style="color: #000000; font-size: 40rpx"
                >&#xe61e;</text
              >
            </view>
          </view>
    ...
    <view class="flex flex-column mt-2 bg-white p-2">
      ...
      <view class="flex justify-between mt-1">
        ...
        <view class="flex">
          <text style="color: #02b1be; font-size: 20rpx"
            >￥<span style="font-size: 30rpx; font-weight: bold">{{
              order.discount
            }}</span></text
          >
        </view>
      ...
      <view class="flex justify-end align-center" style="height: 100rpx">
        <text>金额：</text>
        <text style="color: #e51c23; font-size: 30rpx"
    ...
    <!-- <u-modal v-model="showModal" :zoom="false" :show-cancel-button="true">
      <view class="flex flex-column">
        <view class="flex mt-2">
          ...
          <view style="width: 400rpx" class="flex">
            <text style="color: #000000; font-size: 26rpx">￥5998.00</text>
          </view>
        </view>
        ...
        <view class="flex align-center mt-2">
          ...
          <view style="width: 400rpx" class="flex">
            <input
              ...
              value=""
              placeholder="录入优惠金额"
              style="background-color: #f4f4f4; color: #888"
              class="p-1"
            />
          </view>
        </view>
        ...
        <view class="flex my-2">
          ...
          <view style="width: 400rpx" class="flex">
            <text style="color: #ff0000; font-size: 26rpx">￥5998.00</text>
          </view>
        </view>
      </view>
    </u-modal> -->
...
export default {
  ...
  methods: {
    ...
    ModalConfirm() {
      ...
      uni.navigateTo({
        url:
          "/pages/tabBar/my/OrderWork/SalesOrderDetails?id=" +
          this.id +
          "&CommId=" +
          this.CommId,
      });

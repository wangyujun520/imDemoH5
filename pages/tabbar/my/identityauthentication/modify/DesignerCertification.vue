<template>
	<view class="content">
		...
		<!-- <view class="flex justify-between pl-2 pt-3 pb-2 bg-white" style="min-height: 100rpx;border-bottom: 1px solid rgba(187,187,187,0.2);">
			<text class="" style="color: #101010;font-size: 28rpx;">设计分类</text>
			<view class="flex">
				<view class="flex justify-end flex-wrap" style="width: 520rpx;">
					<text class="rounded mb-1 ml-1" style="color: #FFFFFF;background-color: #FF9900;font-size: 26rpx;padding: 10rpx 30rpx;">一般设计</text>
					<text class="rounded mb-1 ml-1" style="color: #FFFFFF;background-color: #FF9900;font-size: 26rpx;padding: 10rpx 30rpx;">暖通</text>
					<text class="rounded mb-1 ml-1" style="color: #FFFFFF;background-color: #FF9900;font-size: 26rpx;padding: 10rpx 30rpx;">软装</text>
				</view>
				<text class="iconfont" style="font-weight: bold;font-size: 40rpx;color: #555;">&#xe656;</text>
			</view>
		</view> -->
		<!-- <view class="flex justify-between pl-2 pt-3 pb-2 bg-white" style="min-height: 100rpx;border-bottom: 1px solid rgba(187,187,187,0.2);">
			<text class="" style="color: #101010;font-size: 28rpx;">设计擅长</text>
			<view class="flex">
				<view class="flex justify-end flex-wrap" style="width: 520rpx;">
		...
		<view class="flex justify-between pl-2 pt-3 pb-2 bg-white" style="min-height: 100rpx;border-bottom: 1px solid rgba(187,187,187,0.2);">
			...
			<view class="flex">
				<view class="flex justify-end flex-wrap" style="width: 520rpx;">
					<text @click="SelectWorkClass(indexclass)" :class="[itemclass.isLike ? 'Selection' : 'NoSelection']" v-for="(itemclass,indexclass) in DataList.designClassification" :key="indexclass" class="rounded mb-1 ml-1" style="font-size: 26rpx;padding: 10rpx 30rpx;">{{itemclass.name}}</text>
				</view>
				<text class="iconfont" style="font-weight: bold;font-size: 40rpx;color: #555;">&#xe656;</text>
			</view>
		</view>
...
export default {
	...
	onShow() {
		// 设计师认证首页
		var RequrestUrl = this.AJB.BizUrl + 'api/MobileUser/GetMyDesignerDetail';
		var RequrestDatas = {};
	...
	onReady() {},
	methods: {
		SelectWorkClass(index){
			this.DataList.designClassification[index].isLike = !this.DataList.designClassification[index].isLike;
		},
		SelectWork(index){
		...
		Submit(){
			...
			// 设计师基本资料修改
			var RequrestUrl = this.AJB.BizUrl + 'api/MobileUser/SetMyDesignerDetail';
			var RequrestDatas = {
			  "workingYears": this.DataList.workingYears,
			  "company": this.DataList.company,
			  "designClassification": this.DataList.designClassification,

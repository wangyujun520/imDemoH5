<template>
	<view class="content">
		<view class="flex flex-column bg-white px-3 mt-3">
			...
			<view class="border-bottom flex justify-between align-center" style="height: 100rpx;">
				<text class="form-title-style">微信号</text>
				<view class="flex align-center">
					<u-input type="text" v-model="DataList.account" input-align="right" placeholder="请输入微信号"
						placeholder-style="font-size: 26rpx;color: #BEBEBE;" style="width: 500rpx;" />
				</view>
			</view>
			...
			<view class="border-bottom flex justify-between align-center" style="height: 100rpx;">
				...
				<view class="flex align-center">
					<u-input type="number" maxlength="11" v-model="DataList.mobile" input-align="right" placeholder="请输入微信绑定手机号"
						placeholder-style="font-size: 26rpx;color: #BEBEBE;" style="width: 500rpx;" />
				</view>
			</view>
		</view>
		...
		<view class="flex justify-center pt-3">
			<view class="flex justify-center align-center flex-column bg-white rounded"
				...
				<text v-if="DataList.bank_photo==''" class="mt-2"
					style="color: #0072FF;font-weight: bold;font-size: 26rpx;">上传微信收款码</text>
			</view>
		</view>
		...
		methods: {
			Submit() {
				...
				let requestData = {
					...
					pay_qr_code: this.DataList.bank_photo //微信收款码

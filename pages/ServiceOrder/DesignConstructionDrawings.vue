<template>
	<view class="content" style="padding-bottom: 100rpx;">
		<image src="/static/video/demo.jpg" style="width: 750rpx;height: 400rpx;"></image>
		<view class="pt-2 pb-4 bg-white">
			<view class="bg-white" style="height: 80rpx;">
				<view class="bg-white" style="height: 40rpx;"></view>
				<view class="flex justify-center position-relative">
					<view class="position-absolute bg-white flex justify-center" style="width: 140rpx;height: 40rpx;top: -20rpx;">
						<text style="color: #FF9900;font-size: 26rpx;">设计详情</text>
					</view>
					<u-line :hair-line="false" color="#FF9900"/>
				</view>
			</view>
			...
			<view class="px-2 flex align-center" style="height: 60rpx;">
				<view class="" style="width: 440rpx;">
					<text class="text-title">设计师：</text>
					<text class="text-content">咚咚锵</text>
				</view>
			...
			<view class="px-2 flex align-center" style="height: 60rpx;">
				...
				<view class="" style="width: 280rpx;">
					<text class="text-title">价格：</text>
					<text class="text-content">10万</text>
				</view>
			</view>
			<view class="px-2 flex align-center" style="height: 60rpx;">
		...
		<view class="position-fixed" style="height: 100rpx;width: 100%;bottom: 0;">
			<view class="flex bg-white" style="width: 100%;height: 100%;border-top: 1px solid rgba(187,187,187,0.2);">
				...
				<view class="flex align-center justify-start pl-2" style="width: 510rpx;">
					<text style="background-color: #FFFFFF;color: #2979FF;font-size: 26rpx;padding: 10rpx 40rpx;border-radius: 40rpx;border: 1px solid #2979FF;">联系设计师</text>
					<text class="ml-2" style="background-color: #FFFFFF;color: #19BE6B;font-size: 26rpx;padding: 10rpx 40rpx;border-radius: 40rpx;border: 1px solid #19BE6B;">打赏</text>
				</view>
				
				<view class="flex align-center justify-end pr-2" style="width: 240rpx;">
					<text style="background-color: #02B1BE;color: #FFFFFF;font-size: 26rpx;padding: 10rpx 40rpx;border-radius: 40rpx;border: 1px solid #02B1BE;">接受</text>
				</view>
			</view>
		</view>

			...
			<view class="uni-uploader">
				...
				<view class="uni-uploader-body">
					<view class="uni-uploader__files">
						...
						<view @tap="chooseImage" class="flex justify-center align-center flex-column" style="margin:10rpx;width: 190rpx;height: 190rpx;border: 2rpx solid #F7F7F7;background-color: #F7F7F7;" v-if="imageList.length<9">

			...
			<view class="uni-uploader">
				...
				<view class="uni-uploader-body">
					<view class="uni-uploader__files">
						...
						<view @tap="chooseImage" class="flex justify-center align-center flex-column" style="margin:10rpx;width: 208rpx;height: 208rpx;border: 2rpx solid #F7F7F7;background-color: #F7F7F7;" v-if="imageList.length<9">
							<u-icon name="plus" color="#888" size="70"></u-icon>
						...
						uni.getSetting({
							success: (res) => {
								...
								if (!authStatus) {
									uni.showModal({
										title: '授权失败',
										content: '易安需要从您的相机或相册获取图片，请在设置界面打开相关权限',
										success: (res) => {
											if (res.confirm) {
												uni.openSetting()
											}

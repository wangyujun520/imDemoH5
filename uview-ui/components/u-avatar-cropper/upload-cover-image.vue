	...
	<view class="content">
		<view class="page-body uni-content-info">
			...
			<view class='cropper-config'>
				...
				<button type="warn" @click="getImageInfo" style='margin-top: 30rpx;'> 保存 </button>
			</view>
					...
					uni.canvasToTempFilePath({
						...
						success: function (res) {
							...
							Promise.all(uploads).then(response => {
								...
								prevPage.$vm.DataList.cover = response[0];//修改上一页data里面的managingGoods参数值
							...
							// let pages = getCurrentPages();  //获取所有页面栈实例列表
							// let prevPage = pages[ pages.length - 2 ];  //上一页页面实例
							// prevPage.$vm.DataList.cover = "https://ebao-vip-ins.oss-cn-shenzhen.aliyuncs.com/Anjubang/2021/02/2021021916137330905560.png";//修改上一页data里面的managingGoods参数值
							// // 返回上一个界面
							// uni.navigateBack({
							// 	delta:1
							// })
